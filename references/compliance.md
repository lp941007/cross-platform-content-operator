...
- advertising and consumer-protection claims;
- health, medical, finance, education, and other regulated claims;
- minors' image, voice, identity, and performance information;
- copyright, music, footage, logo, and testimonial permissions;
- privacy, confidential business information, and location details;
- comparative, scarcity, ranking, price, and result claims.

For cosmetics and skincare, separate ingredient evidence, finished-product testing, user-reported experience, and efficacy claims. Do not derive finished-product efficacy from ingredient material alone. Match every effect statement to its applicable audience, conditions, sample, and evidence.
...
List specific execution risks and the action needed to clear each risk. Do not replace this with a generic disclaimer.
